...
def load_dataset():
    """加载并构建数据集"""
    # 路径设置
    glaucoma_dir = ROOT_DIR / 'dataset/C_D_G/diabetic_retinopathy'
    normal_dir = ROOT_DIR / 'dataset/C_D_G/normal'

    # 收集样本路径
    glaucoma_samples = [f for f in glaucoma_dir.glob('*.jpeg') if f.is_file()]
